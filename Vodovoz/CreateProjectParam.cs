	...
	partial class MainClass
	{
		...
		static void ConfigureViewModelWidgetResolver()
		{
			...
			ViewModelWidgetResolver.Instance
				...
				.RegisterWidgetForTabViewModel<CarRepairScheduleViewModel, CarRepairScheduleView>()
				.RegisterWidgetForTabViewModel<BreakdownKindViewModel, BreakdownKindView>()
            ...
            ViewModelWidgetResolver.Instance
				...
				.RegisterWidgetForWidgetViewModel<BreakdownKindJournalFilterViewModel, BreakdownKindJournalFilterView>()
